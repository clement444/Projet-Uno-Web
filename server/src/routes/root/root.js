...
export default () => {
  ...
  app.get("/lobby", (req, res) => {
    ...
    res.sendFile(path.join(__dirname, "../../../../client/src/views/lobby.html"));
  });

  app.get("/room", (req, res) => {
    logger_http.info("[GET] /room");
    res.sendFile(path.join(__dirname, "../../../../client/src/views/room.html"));
  });

  app.get("/game", (req, res) => {
    logger_http.info("[GET] /game");
    res.sendFile(path.join(__dirname, "../../../../client/src/views/game.html"));
  });
};
